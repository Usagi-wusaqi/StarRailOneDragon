...
from sr_od.application.sim_universe.operations.auto_run.sim_uni_run_level import SimUniRunLevel
...
from sr_od.application.sim_universe.sim_uni_data import UNI_NUM_CN
