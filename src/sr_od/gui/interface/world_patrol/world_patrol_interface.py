...
class WorldPatrolInterface(PivotNavigatorInterface):
    ...
    def create_sub_interface(self):
        ...
        self.add_sub_interface(WorldPatrolPlanetManageInterface(ctx=self.ctx))
        self.add_sub_interface(WorldPatrolRegionSetManageInterface(ctx=self.ctx))
        self.add_sub_interface(LargeMapRecorderRunInterface(ctx=self.ctx))
